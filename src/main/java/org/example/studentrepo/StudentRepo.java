...
public class StudentRepo implements StudentRepoimpl {
    ...
    public void insertstudentteacher(Student student) {
        try {
            ...
            st.executeUpdate("insert into student values( '" + student.getId() + "', '" + student.getName() + "' ,'" + student.getEmail() + "' )");
            st.executeUpdate("insert into teacher values( '" + student.getTeacher().getId() + "', '" + student.getTeacher().getName() + "' ,'" + student.getTeacher().getEmail() + "' )");
        } catch (Exception e) {
